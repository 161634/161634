...
if XK[5] == true then A5() end
if XK[6] == true then Exit() end
end
CatWill = -1 
end
...
gg.newFolder("/storage/emulated/0/#➩ 破解文件列表")
io.open("/storage/emulated/0/#➩ 破解文件列表/[×𝐃𝐄𝐂×] 𝟽ʜ #Bʏᴘᴀss.lua","w"):write([==[
...
gg.toast("Encrypted by KonɀLeΙ͠\t")
...
"⟬✖ 𝟽ʜ Lᴏʙʙʏ Bʏᴘᴀss A10✖⟭ ",
" ᴇ x ɪ ᴛ "
},nil,(" •┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈• \n۞Official Channel @INJECTOR_7H🇮🇳\n  ❏ 2022/08/30  ᴛɪᴍᴇ: 01:28:17   \n  ❏ ! 「7ʜ」ᴛᴇᴀᴍ ✖ !☔️  \n  •┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈• "))
if XK == nil then else
if XK[1] == true then A1() end
if XK[2] == true then A2() end
if XK[3] == true then Exit() end
end
XGCK = -1
end
...
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_OTHER)
gg.searchNumber("635530605756416;564058054983680", gg.TYPE_QWORD, nil, nil, nil, nil)
gg.getResults(50000)
gg.editAll("288233678981562368", gg.TYPE_QWORD)
gg.clearResults()
gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_OTHER)
...
setvalue(so + 0x6B28420, 4, 50)
setvalue(so + 0x2A8BA7C, 4, 0)
setvalue(so + 0x6B2842C, 4, 57)
gg.alert("⛔ ⭕𝙿𝚁𝙾𝚃𝙴𝙲𝚃𝙸𝙾𝙽 𝙰𝙲𝚃𝙸𝚅𝙰𝚃𝙴𝙳⭕A11✓⛔\n")
end
...
setvalue(so + 0x2A8BA7C, 4, 0)
setvalue(so + 0x6B2842C, 4, 57)
gg.alert("⛔ ⭕𝙿𝚁𝙾𝚃𝙴𝙲𝚃𝙸𝙾𝙽 𝙰𝙲𝚃𝙸𝚅𝙰𝚃𝙴𝙳⭕A10✓⛔\n")
gg.clearResults()
end
